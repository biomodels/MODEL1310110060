# MODEL1310110060: MODEL1310110060
...
`pip install git+https://github.com/biomodels/MODEL1310110060.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL1310110060.git@20140916`

## Usage

Importing the model package.

`import MODEL1310110060 as model`
...
Thiele2013 - Spleen cells in red pulp

The model of spleen cells in red pulp metabolism is derived from the
...
and identified by:
[MODEL1310110060](http://identifiers.org/biomodels.db/MODEL1310110060) .
